...
if __name__ == '__main__':
    ...
    best_policy_filename = "BestPolicy"
    ...
    qlearn = qlearn.QLearn(actions=range(env.action_space.n),
                           alpha=0.2, gamma=0.8, epsilon=0.4)

    
    qlearn.loadQ(best_policy_filename)
    print("_______________Loading best policy_______________")
    print(qlearn.q)
    ...
    for x in range(total_episodes):
        ...
        if highest_reward < cumulated_reward:
            print("_______________Saving best policy_______________")
            highest_reward = cumulated_reward
            qlearn.saveQ(best_policy_filename)
